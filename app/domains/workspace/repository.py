...
class WorkspaceRepository:
    ...
    @staticmethod
    async def create_workspace(db: AsyncSession, workspace: Workspace):
    ...
    @staticmethod
    async def add_member(db: AsyncSession, member: WorkspaceMember):
    ...
    @staticmethod
    async def get_workspace_by_id(db: AsyncSession, workspace_id: UUID):
